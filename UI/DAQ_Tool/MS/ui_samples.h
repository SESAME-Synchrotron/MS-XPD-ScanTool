...
public:
    ...
    void setupUi(QDialog *samples)
    {
        ...
        background->setStyleSheet(QString::fromUtf8("background-image: url(:/sampleContainer/sampleStage(1).png);"));
        background->setPixmap(QPixmap(QString::fromUtf8(":/sampleContainer/sampleStage(1).png")));
        background->setScaledContents(true);
        gridLayoutWidget_2 = new QWidget(samples);
        gridLayoutWidget_2->setObjectName(QString::fromUtf8("gridLayoutWidget_2"));
        gridLayoutWidget_2->setGeometry(QRect(0, 0, 331, 611));
